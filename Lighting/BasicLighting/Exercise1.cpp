...
int main() {
	...
	Shader objShader("shader/2.2.Exercise1_1.vs", "shader/2.2.Exercise1_1.fs");
	Shader lampShader("shader/2.2.Exercise1_2.vs", "shader/2.2.Exercise1_2.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightPos = origin + glm::vec3(glm::sin(glm::radians(time*50.0f)), 0.0f, glm::cos(glm::radians(time*50.0f)));
